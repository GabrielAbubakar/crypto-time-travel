    ...
    return (
        <footer>
            <p className='mt-40 text-center text-sm text-slate-500'>
                ...
                in multiple decimal places. This change encourages simplicity and readability of results.
            </p>

            <p className='text-sm text-center text-slate-500'>
                Made with ❤ by Gabriel Abubakar. <a className='text-blue-700' href="https://github.com/GabrielAbubakar/crypto-time-travel">View Source Code</a>
            </p>
        </footer>
    )
}
